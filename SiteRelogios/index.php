...
<body>
    <div class="header">
        ...
        <div class="nav">
            <div><a href="produtos.php" class="relogios">Relógios</a></div>
    ...
    <footer>
        ...
        <div class="footer-info">
            ...
            <a href="/SiteRelogios/sobre.html" target="_blank">Sobre Nós</a>
            <a href="/SiteRelogios/sobre.html#rolex" target="_blank">Sobre a Rolex</a>
        </div>
        <div class="footer-info">
            <p style="font-size: 2rem;">Novidades</p>
            <a href="/SiteRelogios/produtos.php" target="_blank">Lançamentos e Promoções</a>
